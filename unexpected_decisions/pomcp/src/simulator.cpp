...
double SIMULATOR::JointProb(const STATE& state) const
{
...
void SIMULATOR::DisplayStateId(const STATE& state, std::ostream& ostr) const
{
}

void SIMULATOR::DisplayStateHist(const STATE& state, const char* fileName) const
{
}

void SIMULATOR::Path2Csv(const STATE& state) const
{
}
...
void SIMULATOR::DisplayBeliefIds(const BELIEF_STATE& beliefState, 
    ostream& ostr) const
{
}
...
{
    cout << "stateVarRelationships simulator:" << endl;
    return 0;
}

STATE* SIMULATOR::CreateStartState(std::vector<double*>* stateVarRelationships) const
{
    return 0;
}

STATE* SIMULATOR::CreateStartState(std::vector<STATE*>* allParticles, std::vector<double> allParticleCumProbs) const
{
    return 0;
}

STATE* SIMULATOR::CreateStartStateFixedValues(std::vector<int> values) const
{
    return 0;
}
